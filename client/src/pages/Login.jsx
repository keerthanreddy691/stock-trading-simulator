      ...
      <div className="w-full max-w-sm space-y-6">
        ...
        <div className="flex flex-col items-center gap-3">
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-slate-400 mt-1">Sign in to your trading account</p>
          </div>
        </div>
        ...
        <p className="text-center text-xs text-slate-500">
          No account?{' '}
          <Link to="/register" className="text-indigo-400 font-semibold hover:text-indigo-300 transition">Create one free</Link>
        </p>
